...
?>
          <td ><TABLE  border=0 align="center" cellPadding=2 cellSpacing=1 bgColor=#e1e1e1 onMouseOver="this.style.backgroundColor='#FF6600'" onMouseOut="this.style.backgroundColor=''">
            <TBODY>
             ...
             <br>市场价:<font size=+1 color="#FF0000"><?php echo $data[shichangjia];?> </font>会员价：<font size=+1 color="blue"><?php echo $data[huiyuanjia];?></font><br><a href="shopping.php?id=<?php echo $data[id];?>"><img src="images/gwc.gif" border="0"></a>
